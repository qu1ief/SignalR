...
namespace PustokTask.Data.Migrations
{
    ...
    [Migration("20250419074124_mig_12")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PustokTask.Models.AppUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("PustokTask.Models.BookComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokTask.Models.DbBasketItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokTask.Models.Order", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokTask.Models.OrderItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("PustokTask.Models.Setting", b =>
                {
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("PustokTask.Models.AppUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("PustokTask.Models.BookComment", b =>
                {
                    b.HasOne("PustokTask.Models.AppUser", "AppUser")
                        .WithMany()
            ...
            modelBuilder.Entity("PustokTask.Models.OrderItem", b =>
                {
                    ...
                    b.HasOne("PustokTask.Models.Order", "Order")
                        .WithMany()
